...
| `test_presencia.py` | Presencia que empuja HA: vigencia (TTL), geolocalización derivada de `/weather` y `/maps/departure`, troceo por día del tramo que cruza la medianoche y descarte de los huecos largos |
